...
from .country_specific.korea.kr_account_recognizer import KrAccountNumberRecognizer
from .country_specific.korea.kr_driver_license_recognizer import KrDriverLicenseRecognizer
from .country_specific.korea.kr_phone_number import KrPhoneNumberRecognizer
